<?php  //[STAMP] 6da069a29230fc9b058a88c140cc803f
...
trait UnitTesterActions
{
     ...
     * ``` php
     * <?php
     * $I->createModel('App\Entities\User');
     * $I->createModel('App\Entities\User', ['name' => 'John Doe']);
     * $I->createModel('App\Entities\User', [], 'admin');
     * $I->createModel('App\Entities\User', [], 'admin', 3);
     * ?>
     * ```
     *
     ...
     * ``` php
     * <?php
     * $I->makeModel('App\Entities\User');
     * $I->makeModel('App\Entities\User', ['name' => 'John Doe']);
     * $I->makeModel('App\Entities\User', [], 'admin');
     * $I->makeModel('App\Entities\User', [], 'admin', 3);
     * ?>
     * ```
     *
     * @see http://laravel.com/docs/5.1/testing#model-factories
